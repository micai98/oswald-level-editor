...
function __s_le_cursor() { 
__sprite_init__(this, s_le_cursor, 16, 16, 0, 0, 'Box', 8, 0, 16, 0, 16, ['img/s_le_cursor_0.png']);
}; var s_le_cursor = new __s_le_cursor();
 ...
 ***********************************************************************/
function __bg_grid() { 
__background_init__(this, bg_grid, 'img/bg_grid.png')}; var bg_grid = new __bg_grid();
 ...
 * OBJECTS
 ***********************************************************************/
function __o_le_entity() {
__instance_init__(this, o_le_entity, null, 1, 5, col_16x, 1, 0);
...
}; var o_le_entity = new __o_le_entity();

function __o_main() {
__instance_init__(this, o_main, null, 1, 0, s_le_cursor, 1, 1);
this.on_creation = function() {
with(this) {
...
this.on_step = function() {
with(this) {
if(editor_paused || !document.hasFocus()) return;
...
}; var o_main = new __o_main();

function __o_camera() {
__instance_init__(this, o_camera, null, 0, 0, null, 1, 3);
this.on_creation = function() {
with(this) {
x = 320;
y = 0;
...
tu_scenes.push(s_main);
tu_room_to_go = s_main;


/***********************************************************************
 * CUSTOM GLOBAL VARIABLES
 ***********************************************************************/
// OSWALD LEVEL EDITOR BY MICAI
var camx = 320;
var lvlend = 320;
var lvlheight = 10;
var lvloutput = "";
